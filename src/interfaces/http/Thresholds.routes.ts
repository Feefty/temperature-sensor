...
import type { GetThresholds } from '../../application/TemperatureSensor/GetThresholds.js'
import type { PostThresholds } from '../../application/TemperatureSensor/PostThresholds.js'

export const ThresholdsRoutes = (deps: {
  GetThresholds: GetThresholds
  PostThresholds: PostThresholds
}) => {
  const app = new Hono()
